...
if [ "x$JAVAC_JAR_FILE" != "x" ]; then
 ...
 JBOSS_CLASSPATH="$JBOSS_CLASSPATH:$li/DdtUtils-0.0.1.jar:$li/DdtData-0.0.1.jar:$li/DdtCore-0.0.1.jar:$li/DdtAgent-0.0.1.jar:$li/SA-1.jar:$li/HttpRunner-1.jar"
 ech0 cp $JBOSS_CLASSPATH
 sleep 4

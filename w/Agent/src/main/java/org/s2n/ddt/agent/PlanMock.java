...
import org.s2n.ddt.agent.PlanMock;
import org.s2n.ddt.agent.PlanMockI;
...
public class PlanMock implements PlanMockI {
	...
	public void makeMockTestCase1() {
		...
		testCase1.setActive(new Integer(1));
		...
		param3.setParamName("shalini_mahadevan");
		...
		testCase1.setDescription("Succusesfull");
		...
		testCase2.setDescription("Succusesfull");
		...
		teststepid1TC2.setTestStepId(new BigDecimal(50004));
		...
		teststepid2TC2.setTestStepId(new BigDecimal(50004));
		...
		teststepid3TC2.setTestStepId(new BigDecimal(50004));
		...
		teststepid4TC2.setTestStepId(new BigDecimal(50004));
		...
		teststepid5TC2.setTestStepId(new BigDecimal(50004));
		...
		teststepid6TC2.setTestStepId(new BigDecimal(50004));
	...
	public TestPlan createPlan(String planRunName) {
		...
		planId.setTestPlanId(new BigDecimal(12345));
		...
		ArrayList<TestScenario> testScenarioList = new ArrayList<TestScenario>();
		ArrayList<Feature> featureList = new ArrayList<Feature>();
		ArrayList<Functional> functionalList = new ArrayList<Functional>();
		TestScenario testscenario = new TestScenario();
		testscenario.setTestScenarioName("Cancelling in GRX");
		/*
		 * ArrayList<SuiteScenarioMapping> suiteScenarioMappingsList = new
		 * ArrayList<SuiteScenarioMapping>(); SuiteScenarioMapping
		 * suiteScenarioMapping = new SuiteScenarioMapping();
		 * SuiteScenarioMapping suiteScenarioMapping1 = new
		 * SuiteScenarioMapping();
		 */
		ArrayList<TestSuite> testSuitesList = new ArrayList<TestSuite>();
		/*
		 * TestSuite testSuite = new TestSuite(); TestSuite testSuite1 = new
		 * TestSuite(); TestSuiteResultSummary testSuiteResultSummary = new
		 * TestSuiteResultSummary(); TestStepResult testStepResult = new
		 * TestStepResult(); TestSuiteId testsuiteid = new TestSuiteId();
		 * TestSuiteId testsuiteid1 = new TestSuiteId();
		 * testsuiteid.setTestsuiteid(new BigDecimal(4124));
		...
		testsuiteid.setSuiteName("createOrder");
		testsuiteid.setTestCases(getCases());
		testsuiteid.setTestSuiteId(new BigDecimal(4124));
		 ...
		 */
		TestSuiteId testsuiteid2 = new TestSuiteId();
		testsuiteid2.setSuiteName("create_order");
		testsuiteid2.setTestCases(getCases());
		testsuiteid2.setTestSuiteId(new BigDecimal(4123));
		testSuite2.setTestSuiteId(testsuiteid2);
		/*
		 * suiteScenarioMapping.setCreateddatetime(new Date());
		 * suiteScenarioMapping.setTestsuite(testSuite2);
		 */
		testSuitesList.add(testSuite2);

		/*
		 * testsuiteid1.setTestsuiteid(new BigDecimal(4123));
		 * testsuiteid1.setSuitename("Cancel Order");
		 * testsuiteid1.setTestcases(getCases());
		 * testSuite.setTestsuiteid(testsuiteid);
		 * testSuite1.setTestsuiteid(testsuiteid1);
		 * suiteScenarioMapping.setCreateddatetime(new Date());
		 * suiteScenarioMapping.setTestsuite(testSuite);
		 * suiteScenarioMapping1.setCreateddatetime(new Date());
		 * suiteScenarioMapping1.setTestsuite(testSuite1);
		 * testSuitesList.add(testSuite); testSuitesList.add(testSuite1);
		 */
		...
		feature.setFeatureId(new BigDecimal(9999));
		feature.setFeatureName("Cancelling in GRX");
		feature.setTestSuites(testSuitesList);
		feature.setTestScenarios(testScenarioList);
		featureList.add(feature);
		Functional functional = new Functional();
		functional.setFunctionalId(new BigDecimal(8888));
		functional.setFunctionalName("Creat");
		...
		logger.info("Test Suites count "
				+ testplanList.get(0).getTestPlanId().getPlanScenarioMappingList().get(0).getTestScenario().getTestSuites().size());

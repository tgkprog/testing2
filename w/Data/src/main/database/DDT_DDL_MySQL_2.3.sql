...
ALTER TABLE AppFeature DROP COLUMN ScreenID;

ALTER TABLE Screen ADD COLUMN FeatureID INT NOT NULL;

ALTER TABLE Screen ADD CONSTRAINT FeatureID FOREIGN KEY ( FeatureID) REFERENCES AppFeature ( FeatureID ) ;

ALTER TABLE TestPlan DROP COLUMN TestSuiteID;

ALTER TABLE TestSuite ADD COLUMN TestPlanID INT NOT NULL;

ALTER TABLE TestSuite ADD CONSTRAINT TestPlanID FOREIGN KEY ( TestPlanID ) REFERENCES TestPlan ( TestPlanID ) ;

ALTER TABLE ObjectType DROP COLUMN APPID;

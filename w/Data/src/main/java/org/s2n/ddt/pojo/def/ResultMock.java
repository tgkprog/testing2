...
public class ResultMock {
	...
	public  AgentRunResult mockMap(String planRunName,BigDecimal id) {
		...
		AgentRunResult agentRunResult1 = new AgentRunResult();
		AgentRunResult agentRunResult2 = new AgentRunResult();
		...
		testCaseResult1.setTestStepResultsMap(new BigDecimal(50000), testStepResult1);
		testCaseResult1.setTestStepResultsMap(new BigDecimal(50001), testStepResult2);
		testCaseResult1.setTestStepResultsMap(new BigDecimal(50002), testStepResult3);
		testCaseResult1.setTestStepResultsMap(new BigDecimal(50003), testStepResult4);
		testCaseResult1.setTestStepResultsMap(new BigDecimal(50004),testStepResult5);
		...
		testSteps11.setTestStepId(teststepid11);
		testStepResult11.setResult(false);
		testStepResult11.setTestStep(testSteps11);
		
				
		
		testCaseResult2.setTestStepResultsMap(new BigDecimal(50005),testStepResult6);
		testCaseResult2.setTestStepResultsMap(new BigDecimal(50006),testStepResult7);
		testCaseResult2.setTestStepResultsMap(new BigDecimal(50007),testStepResult8);
		testCaseResult2.setTestStepResultsMap(new BigDecimal(50008),testStepResult9);
		testCaseResult2.setTestStepResultsMap(new BigDecimal(50009),testStepResult10);
		testCaseResult2.setTestStepResultsMap(new BigDecimal(50010),testStepResult11);
		...
		testSuitResult1.setCaseResultsMap(new BigDecimal(1111), testCaseResult1);
		testSuitResult1.setCaseResultsMap(new BigDecimal(2222), testCaseResult2);
		...
		testScenarioResult.setSuiteResultsMap(new BigDecimal(1000), testSuitResult1);
		testScenarioResult.setScenarioId(new BigDecimal(101));
		

		testPlanResult.setScenarioResult(new BigDecimal(101), testScenarioResult);
		testPlanResult.setTestplanid(new BigDecimal(5555555));
		testPlanResult.setFunctional(new BigDecimal(0001),functionality);

		agentRunResult1.setPlanResult(testPlanResult);
		agentRunResult1.setReportFilePath(f1);
		agentRunResult1.setAgentId(new BigDecimal(123));
		agentRunResult1.setAgentName("EXIMR-IM-415");
		agentRunResult1.setTestPlan(testPlan);
		agentRunResult1.setTestPlanId(testPlanId.getTestPlanId());
		agentRunResult1.setPlanRunStartDateTime(d1);
		agentRunResult1.setPlanRunEndDateTime(d2);
		agentRunResult1.setIp("10.1.0.167");
		agentRunResult1.setPort(8080);

		
		/*agentRunResult2.setPlanResult(testPlanResult);
		agentRunResult2.setReportFilePath(f2);
		agentRunResult2.setAgentid(new BigDecimal(12346));
		agentRunResult2.setAgentname("EXIMR-IM-416");
		agentRunResult2.setTestPlan(testPlan);
		agentRunResult2.setPlanRunStartDatetime(d3);
		agentRunResult2.setPlanRunEndDatetime(d4);*/
		
		
		runResult.putAgentRunResultInMap("RunResult1", agentRunResult1);
		//runResult.setAgentRunResult("RunResult2", agentRunResult2);
		runResult.setRunName("Run 1");
		
		return agentRunResult1;

...
page import="com.s2n.tfw.util.SerUtils"%><%@ 
page import="com.s2n.tfw.util.Base64"%><%@ 
page import="java.net.*"%><%@ 
page import="java.io.*"%><%@ 
page import="java.util.*"%><%@ 
page import="javax.net.ssl.*"%><%!

private static Logger logger = Logger.getLogger("com.s2n.tfw.webJsps.serUtl.TestStepSend");
...
private static int timeout = 1000*30; //30 sec
	...
	private static String location = "/data/config/s2n_trust.jks";
